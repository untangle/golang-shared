...
type SessionEvent struct {
	...
	Columns         *structpb.Struct `protobuf:"bytes,4,opt,name=Columns,proto3" json:"Columns,omitempty"`
	ModifiedColumns *structpb.Struct `protobuf:"bytes,5,opt,name=ModifiedColumns,proto3" json:"ModifiedColumns,omitempty"`
}
...
func (x *SessionEvent) GetColumns() *structpb.Struct {
	if x != nil {
		return x.Columns
	}
	return nil
...
func (x *SessionEvent) GetModifiedColumns() *structpb.Struct {
	if x != nil {
...
var file_SessionEvent_proto_goTypes = []any{
...
func file_SessionEvent_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_SessionEvent_proto_msgTypes[0].Exporter = func(v any, i int) any {
