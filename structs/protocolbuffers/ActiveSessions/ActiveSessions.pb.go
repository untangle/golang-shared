...
type Session struct {
	...
	SslSni                          string `protobuf:"bytes,72,opt,name=ssl_sni,json=sslSni,proto3" json:"ssl_sni,omitempty"`
	RemoteAddress                   string `protobuf:"bytes,73,opt,name=remote_address,json=remoteAddress,proto3" json:"remote_address,omitempty"`
	VrfId                           uint32 `protobuf:"varint,74,opt,name=vrf_id,json=vrfId,proto3" json:"vrf_id,omitempty"`
	MacAddress                      string `protobuf:"bytes,75,opt,name=mac_address,json=macAddress,proto3" json:"mac_address,omitempty"`
	VrfName                         string `protobuf:"bytes,76,opt,name=vrf_name,json=vrfName,proto3" json:"vrf_name,omitempty"`
	IpsRule                         uint32 `protobuf:"varint,77,opt,name=ips_rule,json=ipsRule,proto3" json:"ips_rule,omitempty"`
	IpsAction                       string `protobuf:"bytes,78,opt,name=ips_action,json=ipsAction,proto3" json:"ips_action,omitempty"`
}
...
func (x *Session) GetSslSni() string {
	if x != nil {
		return x.SslSni
	}
	return ""
...
func (x *Session) GetVrfId() uint32 {
	if x != nil {
		return x.VrfId
	}
	return 0
...
func (x *Session) GetVrfName() string {
	if x != nil {
		return x.VrfName
	}
	return ""
...
func (x *Session) GetIpsRule() uint32 {
	if x != nil {
		return x.IpsRule
	}
	return 0
...
func (x *Session) GetIpsAction() string {
	if x != nil {
		return x.IpsAction
	}
	return ""
...
var file_ActiveSessions_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xaf, 0x19, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73,
	...
	,
	...
	0x75, 0x66, 0x66, 0x65, 0x72, 0x73, 0x2f, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x53, 0x65, 0x73,
