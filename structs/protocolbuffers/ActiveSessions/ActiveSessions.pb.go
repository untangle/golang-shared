...
type Session struct {
	...
	ThreatPreventionThreatLevel     string `protobuf:"bytes,71,opt,name=threat_prevention_threat_level,json=threatPreventionThreatLevel,proto3" json:"threat_prevention_threat_level,omitempty"`
}
...
var file_ActiveSessions_proto_rawDesc = []byte{
	...
	0x5f, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x47, 0x20, 0x01, 0x28, 0x09, 0x52, 0x1b, 0x74, 0x68,
