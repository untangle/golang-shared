...
type Session struct {
	...
	WanRuleId                       string `protobuf:"bytes,58,opt,name=wan_rule_id,json=wanRuleId,proto3" json:"wan_rule_id,omitempty"`
...
func (x *Session) GetWanRuleId() string {
	if x != nil {
		return x.WanRuleId
	}
	return ""
...
var file_ActiveSessions_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x18, 0x3a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x77, 0x61, 0x6e, 0x52, 0x75, 0x6c,
