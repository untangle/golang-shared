...
build:
	...
	protoc --proto_path=protobuffersrc --go_out=. --go_opt=module=github.com/untangle/golang-shared --go-grpc_out=. --go-grpc_opt=module=github.com/untangle/golang-shared protobuffersrc/*
